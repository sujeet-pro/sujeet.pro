...
export default function Home(props: HomeLayoutProps,) {
  ...
  return (
    <Html
      title={site.home.pageTitle}
      description={site.home.pageDescription}
      url="/"
      site={site}
    >
        ...
        <section class="home-profile">
          ...
          <div class="home-actions">
            ...
            {profileActions.viewCv
              ? <a href="/cv" class="home-action">{profileActions.viewCv}</a>
              : null}
            {profileActions.allArticles
              ? <a href="/articles" class="home-action">{profileActions.allArticles}</a>
              : null}
          </div>
        </section>
              ...
              <div class="home-series-grid">
                {featuredSeries.map((s,) => (
                  <a href={`/articles#${s.slug}`} class="home-series-card">
                    ...
                    {s.description
                      ? <span class="home-series-desc">{s.description}</span>
                      : null}
                  </a>
                ))}
              </div>
              <a href="/articles" class="home-see-all">Browse all articles &rarr;</a>
            </section>
          )
          : null}
                ...
                {featuredArticles.map((a,) => (
                  <li class="home-featured-item">
                    <a href={a.url}>
                      ...
                      {a.description
                        ? <span class="home-featured-desc">{a.description}</span>
                        : null}
                    </a>
                  </li>
                ))}
